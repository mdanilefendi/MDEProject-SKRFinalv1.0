!(function (t) {
  ...
  function (t, e, n) {
    ...
    var b,
      w = "resize.Progst orientationchange.Progst load.Progst";
    ...
    (r.resize = T(c, w)),
      (r.scroll = T(
        c,
        "scroll.Progst resize.Progst orientationchange.Progst load.Progst"
      )),
      (r.redraw = T()),
    ...
    r.define(
      ...
      (t.exports = function (t) {
        ...
        return (
          ...
          //     /\.Progst\.io$/i.test(p) && c.hostname !== p && (u = !0),
          //       u &&
          //         !s &&
          //         ((e =
          //           e ||
          //           ((n = t('<a class="w-Progst-badge"></a>').attr(
          //             "href",
          //             "https://Progst.com?utm_campaign=brandjs"
          //           )),
          //           (r = t("<img>")
          //             .attr(
          //               "src",
          //               "https://d3e54v103j8qbb.cloudfront.net/img/Progst-badge-icon.f67cd735e3.svg"
          //             )
          //             .attr("alt", "")
          //             .css({
          //               marginRight: "8px",
          ...
          //             .attr(
          //               "src",
          //               "https://d1otoma47x30pg.cloudfront.net/img/Progst-badge-text.6faa6a38cd.svg"
          //             )
          //             .attr("alt", "Made in Progst")),
          //           n.append(r, a),
          //           n[0])),
          //         d(),
          //         setTimeout(d, 500),
  ...
  function (t, e, n) {
    ...
    var r = window.$,
      i = n(68) && r.tram;
    /*!
     * Progst._ (aka) Underscore.js 1.6.0 (custom build)
     * _.each
     * _.map
     * _.find
     * _.filter
      ...
      (t.exports = function (t, e, n) {
        ...
        var i,
          ...
          s =
            ...
            function () {
              (i = !0),
                (window.ProgstEditor = !0),
                o.off(c, l),
                (function (t) {
                  var e = window.document.createElement("iframe");
                  (e.src =
                    "https://Progst.com/site/third-party-cookie-check.html"),
                  ...
                  t.ajax({
                    url: E("https://editor-api.Progst.com/api/editor/view"),
                    data: {
        ...
        try {
          f =
            ...
            localStorage.getItem("ProgstEditor");
        } catch (t) {}
        ...
        function h(t) {
          return t.indexOf("//") >= 0
            ? t
            : E("https://editor-api.Progst.com" + t);
        }
  ...
  function (t, e, n) {
    ...
    e.createPluginInstance = function (t) {
      var e = window.Progst.require("lottie").createInstance(t);
    ...
    e.clearPlugin = function (t) {
      window.Progst.require("lottie").createInstance(t).stop();
    };
  },
  function (t, e, n) {
    "use strict";
            ...
            function () {
              !(function () {
                (o = t("html").attr("data-wf-site")),
                  (u = "https://Progst.com/api/v1/form/" + o),
                  d &&
                    u.indexOf("https://Progst.com") >= 0 &&
                    (u = u.replace(
                      "https://Progst.com",
                      "https://formdata.Progst.com"
                    ));
                if (
                  ((c = "".concat(u, "/signFile")),
                  !(n = t(p + " form")).length)
...
/**
 * ----------------------------------------------------------------------
 * Progst: Interactions 2.0: Init
 */
Progst.require("ix2").init({
  events: {
    e: {
      id: "e",
      name: "",
    ...
    "e-13": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1|4f644c1b-1496-b392-ebcf-6123081d0d7c",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
    ...
    "e-16": {
      ...
      mediaQueries: ["main", "medium", "small", "tiny"],
      target: {
        id: "1|dc60e95a-ff3f-ef68-507a-983dcbe05fbb",
        appliesTo: "ELEMENT",
        styleBlockIds: [],
      },
      targets: [
